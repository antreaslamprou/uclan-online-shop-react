        ...
        <div key={props.product.product_id} className="card product">
            ...
            <div className="card-body bg-body-secondary">
                ...
                <span className="card-text">
                    ...
                    {!props.dontShowLink && (<Link to={`${process.env.REACT_APP_API_URL}/products?id=${props.product.product_id}`} className="card-text btn d-inline-block p-0 text-primary ps-1">Read More</Link>)}
                </span>
